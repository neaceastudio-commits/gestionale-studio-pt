...
Il file `netlify.toml` pubblica la cartella `app/`.

Flusso consigliato:

1. inizializzare repo Git;
2. collegare repo a Netlify;
3. tenere `app/` come publish directory;
4. usare Supabase come database master.
